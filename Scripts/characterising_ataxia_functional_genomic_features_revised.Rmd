...
## 1.2 Repetitive elements
- Annotation adapted from http://www.repeatmasker.org/species/hg.html
...
## 1.3 Supplementary Figure 2 - All repeat elements
...
Fig2 <- ggarrange(number_of_STRs_per_gene, number_of_trinucleotides_per_gene, number_eSTRs_per_gene,
